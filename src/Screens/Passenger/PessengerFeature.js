      ...
      <View style={styles.mainContent}>
        ...
        {advancedBooking && (
          <View style={styles.availableCaptainsContainer}>
            ...
            {/* Display available captains for advanced booking */}
            {/* This can be a list or grid of captains */}
...
const PassengerFeatures = ({ navigation }) => {
  ...
  const searchCaptains = () => {
    ...
    // Example: Update state with available captains
    // setAvailableCaptains(availableCaptains);
  };
